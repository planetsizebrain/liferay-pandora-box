...
import be.planetsizebrain.crash.plugin.LiferayMailPlugin
...
@Usage("interact with Liferay mail")
class email {
  ...
  class impl extends Pipe<Object, Object> implements ScreenContext {
    ...
    void open() throws ScriptException {
      ...
      plugin = crash.context.getPlugin(LiferayMailPlugin.class);
    }
